...
integer, parameter :: iVNO3  = 3
integer, parameter :: iVPHY  = 4
integer, parameter :: iCOVNP = 5
integer, parameter :: NVAR   = iCOVNP   ! Total number of biological tracers
integer            :: iPHYC(NPHY)=0     ! Needed for compilation
integer            :: iZOO, iVZOO, iCOVPZ, iCOVNZ     ! Needed for compilation
...
integer, parameter :: oCHLt  = iCOVNP  + 1
...
integer, parameter :: NPar    = ibeta     ! Total number of parameters
