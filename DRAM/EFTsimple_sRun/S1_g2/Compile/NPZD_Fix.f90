...
DO k = 1, nlev
   ...
   CALL MONOD(Temp(k), PAR(k), NO3,params(imu0),params(iQ0N),params(iaI0_C), &
               bI0, params(iKN), DFe(k), KFe_,                        &
               muNet, QN, Varout(oTheta(1),k),                          &
   ...
   CALL MONOD(Temp(k), par_, NO3,params(imu0),params(iQ0N),params(iaI0_C), &
               bI0,  params(iKN), DFe(k), KFe_,                        &
               muNet,Varout(oQN(1),k), Varout(oTheta(1),k),                &
               Varout(oSI(1),k), Varout(oLno3(1),k))
