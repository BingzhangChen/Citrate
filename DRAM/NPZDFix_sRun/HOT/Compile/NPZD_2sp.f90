...
real :: pp_PN  = 0d0
real :: CHLtot = 0d0
real :: muNet,QN,QP,alphaG,Kp,gmax,RDN,mz,PHYtot1
real :: KFe_
...
!! Phytoplankton section:
   ...
   ! MONOD(Temp, PAR,NO3,PO4,mu0,Qnmin,Qpmin,aI0,bI0,KN,KP,DFe,KFe,muNet,QN,QP,theta,SI,Lno3)
     ...
     CALL MONOD( Temp(k), PAR(k),NO3,PO4,mu0(i),params(iQ0N),Qpmin, &
                 aI0(i),bI0(i),                           &
    ...
    ! Calculate phytoplankton growth rate, theta, and QN based on environmental conditions
     CALL MONOD(Temp(k), par_, NO3, PO4, mu0(i),params(iQ0N),Qpmin,&
                 aI0(i),bI0(i),  &
