...
real     :: I_zero
integer  :: NVAR, Nout, iZOO, iDET, iDET2, iPMU, iVAR
...
integer  :: oD_NO3,oD_ZOO,oD_DET,oD_DET2,oD_PMU,oD_VAR,oPAR_
...
integer  :: ithetamin,iQNmin,iVTR, igb
...
integer, parameter :: eDFe       = 6
integer, parameter :: TNFo       = eDFe  ! TOtal number of forcings

! Total of observation times in forcing data
character(LEN=5), parameter :: LabelForc(TNFo) = (/'temp','NO3','Aks','wROMS','par', 'DFe'/)
integer,          parameter :: NFobs(TNFo)     = (/    12,   12, 360,     12,  12,   12 /)
