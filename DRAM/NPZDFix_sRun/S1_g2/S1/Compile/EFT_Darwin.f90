SUBROUTINE FLEXEFT_Darwin
! This model assumes 4 size classes, in each size class there are two species
! One is high-light, low nutrient adapted and have higher mumax 
! and the other low-light, high nutrient adapted and have lower mumax
use bio_MOD
implicit none
integer :: i,j,k
real :: dx,par_
