...
paramlab[5]    <- expression(paste(log[10]*' '*italic(W)[d]))
paramlab[6]    <- expression(paste(italic(alpha)['0,C']))
#paramlab[8]    <- expression(paste(italic(alpha)[µ]))
#paramlab[9]    <- expression(paste(italic(beta)[µ]))
paramlab[7]   <- expression(paste(italic(alpha)[I]))
#paramlab[11]   <- expression(paste(italic(alpha)[K]))
paramlab[8]   <- expression(paste(italic(u)))
paramlab[9]   <- expression(paste(italic(K)['0,fer']))
